...
class KDiffusionSampler:
    ...
    def get_sigmas(self, steps):
        ...
        sigma_min, sigma_max = self.model_wrap.sigma_min, self.model_wrap.sigma_max
    ...
    def __call__(self, x, sigmas, sampler_extra_args, seed, deterministic, steps=None):
        ...
        if 'sigma_min' in parameters:
            extra_params_kwargs['sigma_min'] = self.model_wrap.sigma_min
            extra_params_kwargs['sigma_max'] = self.model_wrap.sigma_max
